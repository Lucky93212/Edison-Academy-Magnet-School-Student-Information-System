...
from .views import (
        PointsView, generate_winners, profile, profile_single, admin_panel, 
...
urlpatterns = [
    ...
    path('students/points', PointsView.as_view(), name='points_list'),
    path('generate_winners', generate_winners, name='generate_winners'),
